<template>
    <div class="projectContainer">
        <img class="ring-2 ring-gray-200 dark:ring-slate-500" src="@/assets/img/projects/aplatero_app.png" style="margin-left: auto; margin-right: auto;">
        <p class="projectTitle mt-5 dark:text-white">Aplatero - an Automated Watering System</p>
