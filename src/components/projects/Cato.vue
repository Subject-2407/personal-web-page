<template>
    <div class="projectContainer">
        <img class="ring-2 ring-gray-200 dark:ring-slate-500" src="@/assets/img/projects/cato_landing.png" >
        <p class="projectTitle mt-5 dark:text-white">Cato - a LMS Platform</p>
